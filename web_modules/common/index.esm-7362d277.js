        ...
        function r(t, n) {
            ...
            return (
                ...
                Error.captureStackTrace &&
                    Error.captureStackTrace(i, b.prototype.create),
                i
            );
        }
        return (t(r, e), r);
        ...
        (e.prototype.subscribe = function (e, t, r) {
            ...
            (void 0 ===
                (n = (function (e, t) {
                    ...
                    ? e
                    : { next: e, error: t, complete: r }).next && (n.next = N),
                void 0 === n.error && (n.error = N),
                void 0 === n.complete && (n.complete = N));
    ...
    A = (function () {
        ...
        return (
            ...
            (e.prototype.getImmediate = function (e) {
                var t = r({ identifier: "[DEFAULT]", optional: !1 }, e),
                    n = t.identifier,
                    i = t.optional,
            ...
            (e.prototype.setComponent = function (e) {
                ...
                try {
                    for (
                        var n = o(this.instancesDeferred.entries()),
                            i = n.next();
                        !i.done;
                        i = n.next()
                    ) {
        ...
        return (
            ...
            (e.prototype.debug = function () {
                ...
                (this._userLogHandler &&
                    this._userLogHandler.apply(this, P([this, D.DEBUG], e)),
                    this._logHandler.apply(this, P([this, D.DEBUG], e)));
            }),
            (e.prototype.log = function () {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                (this._userLogHandler &&
                    this._userLogHandler.apply(this, P([this, D.VERBOSE], e)),
                    this._logHandler.apply(this, P([this, D.VERBOSE], e)));
            }),
            (e.prototype.info = function () {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                (this._userLogHandler &&
                    this._userLogHandler.apply(this, P([this, D.INFO], e)),
                    this._logHandler.apply(this, P([this, D.INFO], e)));
            }),
            (e.prototype.warn = function () {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                (this._userLogHandler &&
                    this._userLogHandler.apply(this, P([this, D.WARN], e)),
                    this._logHandler.apply(this, P([this, D.WARN], e)));
            }),
            (e.prototype.error = function () {
                for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                (this._userLogHandler &&
                    this._userLogHandler.apply(this, P([this, D.ERROR], e)),
                    this._logHandler.apply(this, P([this, D.ERROR], e)));
            }),
            e
        );
    })();
        ...
        n = {
            ...
            initializeApp: function (r, i) {
                ...
                if ("string" != typeof a || !a)
                    throw V.create("bad-app-name", { appName: String(a) });
                if (O(t, a)) throw V.create("duplicate-app", { appName: a });
                var s = new e(r, o, n);
                return ((t[a] = s), s);
            },
            app: i,
    ...
    function a(a) {
        ...
        if (r.has(l))
            return (
                ...
                "PUBLIC" === a.type ? n[l] : null
            );
        if ((r.set(l, a), "PUBLIC" === a.type)) {
            var p = function (e) {
                if ((void 0 === e && (e = i()), "function" != typeof e[l]))
                    throw V.create("invalid-app-argument", { appName: l });
                return e[l]();
            };
            (void 0 !== a.serviceProps && c(p, a.serviceProps),
                (n[l] = p),
        ...
        try {
            for (
                var f = o(Object.keys(t)), h = f.next();
                !h.done;
                h = f.next()
            ) {
                var d = h.value;
...
!(function (e, t) {
    (e.INTERNAL.registerComponent(
        ...
        e.registerVersion("@firebase/app", "0.6.1", t),
