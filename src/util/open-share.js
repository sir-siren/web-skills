...
export async function openShare({ title, text, url }) {
    ...
    const shareOptions = [
        ...
        [
            ...
            () =>
                openShareUrl(
                    `https://wa.me/?text=${encodeURIComponent(`${title}. ${text}. Find it here ${url}`)}`,
                ),
        ],
        [
            "Facebook",
        ...
        [
            ...
            () =>
                openShareUrl(
                    `mailto:?subject=${safeTitle}&body=${encodeURIComponent(`${text}. Find it here ${url}`)}`,
                ),
        ],
        [
            "Hacker News",
        ...
        [
            ...
            () =>
                openShareUrl(
                    `https://www.blogger.com/blog-this.g?n=${safeTitle}&b=${encodeURIComponent(`${text}. Find it <a href="${url}">here</a>.<br/><br/><img width="400" src="${img}" />`)}`,
                ),
        ],
        [
            "Tumblr",
