...
export class App extends LitElement {
    ...
    setupCompact() {
        ...
        // Set initial compact
        this.compact =
            window.innerWidth <= DEFAULT_COMPACT_PX || loadIsCompact();
    }
    ...
    async signIn() {
        try {
            ...
            const { openDialog } =
                await import("./../web_modules/web-dialog.js");
    ...
    render() {
        ...
        return html`
            <div id="skip-navigation">
                ...
                <div>
                    <span
                        >Press <kbd>alt</kbd> + <kbd>/</kbd> to open this
                        menu</span
                    >
                </div>
            </div>
            ...
            <footer id="footer">
                <div>
                    ${user != null
                        ? html`
                              <ws-button @click="${signOut}"
                                  >🔓 Sign out</ws-button
                              >
                          `
                        : html`
                              <ws-button @click="${signIn}"
                                  >🔒 Sign in with Google</ws-button
                              >
                          `}
                    <a
                    ...
                    >
                        <ws-button
                            >☕️ Support me with a cup of coffee</ws-button
                        >
                    </a>
                </div>
            </footer>
