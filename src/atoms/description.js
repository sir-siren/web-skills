...
export class Description extends LitElement {
        ...
        return [
            ...
            css`
                ...
                :host:before {
                    content: "";
                    border-style: solid;
                    border-width: 0 var(--spacing-sm) var(--spacing-sm)
                        var(--spacing-sm);
    ...
    get isCompleted() {
        return !this.isAuthenticated
            ? true
            : auth.hasCompletedSkill(this.skillId);
    }
    ...
    connectedCallback() {
        ...
        if (IS_TOUCH) {
            ...
            window.addEventListener("scroll", this.requestClose, {
                passive: true,
            });
        } else {
            this.addEventListener("focusout", this.requestClose, {
                passive: true,
            });
        }
    }
    ...
    updateDirection() {
        ...
        this.directionX =
            left + width + directionOffset >= window.innerWidth
                ? "left"
                : "right";
        this.directionY =
